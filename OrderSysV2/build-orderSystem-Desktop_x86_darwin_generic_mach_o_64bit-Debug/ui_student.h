...
public:
    ...
    void setupUi(QWidget *Student)
    {
        ...
        frame->setGeometry(QRect(20, 0, 571, 171));
        ...
        tableWidget_roomMargin->setGeometry(QRect(10, 20, 311, 131));
        pushButton_applyOrder = new QPushButton(frame);
        pushButton_applyOrder->setObjectName(QString::fromUtf8("pushButton_applyOrder"));
        pushButton_applyOrder->setGeometry(QRect(360, 120, 112, 32));
        widget = new QWidget(frame);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(340, 10, 168, 121));
        ...
        frame_2->setGeometry(QRect(20, 170, 571, 281));
